...
export function Home() {
  ...
  return (
    <main className="min-h-screen bg-bg flex flex-col items-center justify-center px-4">
      {/* Badge */}
      <div className="mb-6 px-4 py-1.5 border border-accent/40 rounded-full bg-accent/5">
      ...
      {/* Logo */}
      <h1 className="font-display font-bold text-6xl md:text-8xl text-ink tracking-widest mb-2 leading-none">
        NARUTODLE
      </h1>

      {/* Subtitle */}
      <p className="font-body text-base text-muted mb-10 tracking-wide">
      ...
      <div className="flex flex-col items-center gap-3 w-full max-w-xs">
        <button
          ...
          className="w-full py-4 bg-accent text-white font-display font-semibold text-lg tracking-widest rounded-lg hover:bg-accent/90 transition-all active:scale-95"
        >
      ...
      {/* Stats row */}
      <div className="flex gap-8 mt-12 border-t border-border pt-8">
        {[
